...
Content to be given by Ruchika              </p>
          ...
          <div className="flex flex-col overflow-hidden -mt-64">
            <ContainerScroll
              titleComponent={null}
            >
              <img src="https://botsensei.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fdashboard.fd2852c7.png&w=1080&q=75" alt="Bot Interface" height={600}
                width={1000}
                className="mx-auto rounded-2xl object-cover h-full object-left-top"
                draggable={false} />
              {/* <Image
                src={"https://botsensei.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fdashboard.fd2852c7.png&w=1080&q=75"}
                alt="Bot Interface"
                height={600}
                width={1000}
                className="mx-auto rounded-2xl object-cover h-full object-left-top"
