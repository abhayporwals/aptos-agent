...
const SkeletonThree = () => {
  ...
  return (
    // <Image alt="Smart" width={2000} height={120} src={""}/>
    <img src="https://botsensei.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fdj.4172dcc4.png&w=2048&q=75" alt="Smart" width={2000} height={120} />
  );
};
const SkeletonFour = () => {
  const first = {
